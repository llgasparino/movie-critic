...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO posts (user_id, title, content, rating, movie_cover, created_at)
            VALUES ('$user_id', '$title', '$content', '$rating', '$movie_cover', NOW())";
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <div class="form-group">
                    <label for="movie_cover">Link da Capa do Filme</label>
                    <input type="text" class="form-control" id="movie_cover" name="movie_cover">
                </div>
